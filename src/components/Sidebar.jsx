...
const Sidebar = () => {
  ...
  const renderIcon = (name) => {
    switch (name) {
      ...
      case 'bell': return <svg className="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>;
  ...
  return (
    <aside className="fixed left-0 top-0 w-64 h-screen bg-dark-800 border-r border-dark-600 flex flex-col z-20">
      ...
      <div className="p-4 border-t border-dark-600 bg-dark-900/30">
        <NavLink to="/dashboard/configuracion" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
